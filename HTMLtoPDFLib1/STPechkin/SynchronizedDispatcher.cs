...
namespace TuesPechkin
{
    ...
    internal static class SynchronizedDispatcher
    {
        ...
        public static TResult Invoke<TResult>(Util.Func<TResult> @delegate)
        {
            // create the task
        ...
        /// <param name="task">delegate to run on the thread</param>
        /// <returns>result of an action</returns>
        public static void Invoke(Util.Action @delegate)
        {
            // create the task
        ...
        private class Task
        {
            public Task(Util.Action action)
            {
                this.Action = action;
            }

            public virtual Util.Action Action { get; protected set; }
        ...
        {
            public Task(Util.Func<TResult> @delegate) : base(null)
            {
            ...
            // task code
            public Util.Func<TResult> Delegate { get; private set; }
